...
{	char message[100];char nickname[100];char password[100];
	char sql[100];char str[100];char* error_message;
	...
	if(strcmp(message,"quit")==0){
			...
			if(strstr(str,nickname)){
				...
				database_descriptor=sqlite3_exec(database,sql,callback,str,&error_message);
				if(strstr(str,password)) write(tdL.cl,"V-ati logat!",sizeof("V-ati logat!"));
	...
	else{ write(tdL.cl,"Command not found!",sizeof("Command not found!")); }

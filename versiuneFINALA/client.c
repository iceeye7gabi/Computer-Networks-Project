...
printf(green_color"Aceasta aplicatie este realizata de catre Constantinescu George-Gabriel, grupa 2E3, in cadrul cursului Retele De Calculatoare. \n" white_color);
printf(green_color"Profesor indrumator: Andrei Panu \n\n\n"white_color);
  ...
  while (1) {
    ...
    if (strcmp(message, "quit") == 0) {                   //comanda quit
      ...
      if(strcmp(logare,"V-ati logat! Bine ai venit jucatorule!")==0 || strcmp(logare,"V-ati logat! Bine ai venit administratorule!")==0)
            logged=1;
      if(strcmp(logare,"Restricted!")==0) break;
      //else if(strcmp(logare,"V-ati logat! Bine ai venit jucatorule!")==0) bool=1;
      //if(bool==1) break;
          }
      ...
      printf("Trebuie sa va logati pentru a folosi aceasta comanda!\n");
        ...
        printf("Trebuie sa fiti administrator!\n");
    ...
    else if ((strcmp(message, "vote") == 0) && (logged==1) ){
          write(socket_descriptor,"nicetry",sizeof("nicetry"));
          ...
          printf("%s\n", logare);
          fflush(stdout);
    }else if ((strcmp(message, "vote") == 0) && (logged==0) ){
